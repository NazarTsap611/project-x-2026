...
const pairsData = [
    { id: 1, words: ['8 марта', 'Цветы'], message: "💐 <b>Константа:</b> Это было просто" },
    { id: 2, words: ['2.5 месяца', 'Расстояние'], message: "🔒" },
    ...
    { id: 7, words: ['Поддержка', 'Лондон'], message: "🤝" },
